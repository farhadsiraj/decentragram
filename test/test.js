...
contract('Decentragram', ([deployer, author, tipper]) => {
  ...
  describe('images', async () => {
    ...
    it('allows users to tip images', async () => {
      ...
      // Wei is like Ether's penny. To get around using decimal places, Ether is converted to Wei when being transfered (Wei is a large number)
      ...
      // FAILURE: That image does not exist
